...
def render_empty_state():
    ...
    st.markdown(
        ...
        '<div class="es-desc">Upload IRS Form 990 XML filings, QuickBooks reports, or search ProPublica to instantly generate '
        ...
        '<div class="es-t">Upload or Search</div><div class="es-d">Upload Form 990 XMLs, QuickBooks Profit &amp; Loss / Balance Sheet reports, or search ProPublica.</div></div>'
        ...
        '</div><div class="es-hint">Supports IRS Form 990 XML e-file format &amp; QuickBooks Excel/CSV exports \u00b7 <b>Search ProPublica</b> in the sidebar to find any nonprofit</div></div>',
